...
public class Test
{
    ...
    public static void main() throws Exception
    {
        ...
        initBaseJsonObj.put("Base", "Suivez attentivement les instructions de votre guide a l'etape indiquee");
        initBaseJsonObj.put("Base", "Commence avec l'etape numero 1");
        ...
        erreurBaseJsonObj.put("Base", "Ce n'est pas le bon bac!!!");
        ...
        while(true)
        {
            try
            {
                ...
                if(t_inputIOs[0].isHigh())
                {
                    ...
                    {
                        erreurBaseJsonObj.put("Base", "Allez a l'etape numero " + numPageCourante);
