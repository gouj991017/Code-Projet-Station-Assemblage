TITLE: Code de la base possédant un interface usager et adapté aux fichiers d'instructions du programme "Générateur d'instructions".
DESCRIPTION: S'occupe des fonctions expliquées dans le «README.TXT» précédant.
Il s'agit d'une version de code adaptable selon le fichier d'instruction ouvert. Le contenu des étapes (nombre de pièce à prendre,
...
-Terminal_Base_V2.0\src\terminal_base\UI_Base.java
Nom des classes et packages nécéssaires (Terminal_Base_V2.0\src\terminal_base)
-Box.java
-Etape.java
-Piece.java
